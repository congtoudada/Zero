/****************************************************
  文件：UniEventGroupKit.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024-02-05 21:06:29
  功能：
*****************************************************/
...
{
    public class UniEventGroupKit : IUniEventGroupKit
    {
        ...
        public void AddListener<TEvent>(System.Action<IEventMessage> listener) where TEvent : IEventMessage
        {
            ...
            if (_cachedListener[eventType].Contains(listener) == false)
            {
                ...
                UniEventKit.Instance.AddListener(eventType, listener);
            }
            else
            {
        ...
        public void RemoveAllListener()
        {
            foreach (var pair in _cachedListener)
            {
                ...
                {
                    UniEventKit.Instance.RemoveListener(eventType, pair.Value[i]);
                }
                pair.Value.Clear();
            }
